        ...
        opts = {
            symbols = {
                icons = {
                    ...
                    Component = { icon = '󰅴', hl = 'TSFunction' },
                    Fragment = { icon = '󰅴', hl = 'TSConstant' },
                    TypeAlias = { icon = ' ', hl = 'TSType' },
                    Parameter = { icon = ' ', hl = 'TSIdentifier' },
                    StaticMethod = { icon = ' ', hl = 'TSFunction' },
                    Macro = { icon = ' ', hl = 'TSFunction' },
                }
            },
            providers = {
